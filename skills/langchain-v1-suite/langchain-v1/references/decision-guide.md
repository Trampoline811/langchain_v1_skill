...
> **来源**: Harrison Chase 博文 "[Agent Frameworks, Runtimes, and Harnesses](https://www.langchain.com/blog/agent-frameworks-runtimes-and-harnesses-oh-my)" (2025.10) + 官方 `langchain-overview.md` + `langgraph-overview.md`
> **定位**: 专门回答"我的 RAG pipeline 要不要引入 LangChain/LangGraph"这类问题。
> **文中标记**: 无标记 = 官方文档提炼 | `[社区]` = 社区实战验证
...
# 中断：在需要审核的节点调用 interrupt() 函数
def audit_step(state):
    interrupt({"action": "review_required", "data": state["plan"]})
