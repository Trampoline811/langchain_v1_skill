...
| `langchain-hitl-deep-dive.md` | Human-in-the-Loop 深度剖析 | 三层架构贯通（LangGraph interrupt() → LangChain Middleware → DeepAgents interrupt_on）、四种决策模式、条件中断与风险分层、子Agent HITL 编排、流式 HITL | 2026-07-09 |
